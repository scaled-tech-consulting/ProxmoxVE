...
curl -fsSL "https://raw.githubusercontent.com/scaled-tech-consulting/ProxmoxVE/main/tools/addon/daemonsync_2.2.0.0059_amd64.deb" -o "daemonsync_2.2.0.0059_amd64.deb"
