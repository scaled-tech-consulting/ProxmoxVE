#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/scaled-tech-consulting/ProxmoxVE/main/misc/build.func)
...
function update_script() {
  ...
  msg_error "An old installation was detected. Please recreate the LXC from scratch (https://github.com/scaled-tech-consulting/ProxmoxVE/pull/4848)"
  exit 1
  fi
  if [[ ! -d /opt/pulse ]]; then
